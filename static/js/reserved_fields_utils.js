/**
 * 角色保留字段加载工具（供 chara_manager.js / character_card_manager/ 分片共用）。
 *
...
const ReservedFieldsUtils = (() => {
    ...
    const SYSTEM_RESERVED_FIELDS_FALLBACK = Object.freeze([
        ...
        'lighting', 'vrm_rotation', 'live2d_item_id', 'live2d_idle_animation',
        'pngtuber', 'pngtuber_idle_image', 'pngtuber_talking_image', 'pngtuber_happy_image',
        'pngtuber_sad_image', 'pngtuber_angry_image', 'pngtuber_surprised_image',
